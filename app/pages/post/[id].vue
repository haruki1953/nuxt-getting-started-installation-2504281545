...
import BottomSkeleton from './_partials-id/BottomSkeleton.vue'
        ...
        <Col1Layout>
          ...
          <div v-else>
            <DataContainerMountedMask :disabled="haveMainPostOnSetUp">
              ...
              <BottomSkeleton :show="isShowSkeleton" />
            </DataContainerMountedMask>
          </div>
          <!-- 没有回帖 -->
        </Col1Layout>
    ...
    <div v-else>
      <DataContainerMountedMask>
        <Col2Layout :span="12">
          <template #colLeftSm>
            <TopBar title="查看推文" />
            <div v-if="mainPostGroup" class="main-post-group-box">
              <PostGroup :data="mainPostGroup" />
            </div>
          ...
          <template #colRight>
            <div v-if="postPoolItem" class="replies-post-group-box">
